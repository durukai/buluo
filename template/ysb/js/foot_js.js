...
function clearcookie() {
    document.cookie = "qy_username=; path=/;domain=qizidy.com;expires=" + new Date(1970, 1, 1).toGMTString(),
        document.cookie = "qy_userpwd=; path=/;domain=qizidy.com;expires=" + new Date(1970, 1, 1).toGMTString(),
        document.cookie = "qy_userid=; path=/;domain=qizidy.com;expires=" + new Date(1970, 1, 1).toGMTString()
}
function userreg() {
    if ("Email" == $("#email").val()) $.showfloatdiv({
        ...
        if ("" != $("#u_password1").val()) return $("#regform").qiresub({
            curobj: $("#register11"),
            txt: "数据提交中,请稍后...",
            onsucc: function(a) {
            ...
            url: Root + "index.php?m=user-reg.html"
        }),
            !1;
        $.showfloatdiv({
            txt: "请输入密码"
...
function userlogin() {
    if ("用户名或Email" == $("#u_name").val()) $.showfloatdiv({
        txt: "请输入正确的用户名"
    }),
        $("#u_name").focus(),
        $.hidediv({});
    else {
        if ("" != $("#u_password2").val()) return $("#loginform_web").qiresub({
            curobj: $("#btnLogin"),
            txt: "数据提交中,请稍后...",
            onsucc: function(a) {
                if ($.hidediv(a), parseInt(a["rcode"]) > 0) {
            ...
            url: Root + "index.php?m=user-check.html"
        }),
            !1;
        $.showfloatdiv({
            txt: "请输入密码"
...
pp = null,
            ...
            1 == b.wantclose ? (c = $('<div class="tbmovbox-overlayBG" id="tbmovbox_overlay"></div><div id="tbmovbox" class="tbmovbox png-img"><iframe frameborder="0" class="ui-iframe"></iframe><table class="ui-dialog-box"><tr><td><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-tip alert" id="ui-cnt"><span id="xtip">' + b.txt + '</span></div></div><div class="ui-dialog-close"><span class="close">关闭</span></div></div></td></tr></table></div>'), $("body").append(c), $("#tbmovbox_overlay").fadeIn(500), $("#tbmovbox").fadeIn(500), $("#ui-cnt").removeClass("succ error alert loading").addClass(b.cssname), $(".ui-dialog-close").click(function() {
                ...
                success: function(a) {
                    null != a.msg && void 0 != a.msg ? $("#xtip").html(a.msg) : $("#xtip").html(b.completetxt),
                        b.succdo(a),
                        null != a.wantclose && void 0 != a.wantclose ? $.hidediv(a) : 1 == b.autoclose && $.hidediv(a),
    ...
    jQuery.hidediv = function(a) {
        ...
        a = a || {},
            $.extend(b, a),
        null != a.msg && void 0 != a.msg && $("#ui-cnt").html(a.msg),
    ...
    function(a) {
        a.fn.qiresub = function(b) {
            ...
            return b.curobj.attr("disabled", !0),
                d = b.curobj.offset(),
                b = a.extend(c, b),
                a.showfloatdiv({
                    offset: d,
            ...
            {
                post: function(d) {
                    a("#ui-cnt").removeClass("succ error alert").addClass("loading"),
                        a.post(d.url, e.serializeArray(),
                            function(d) {
                                b.curobj.attr("disabled", !1),
                                    c.onsucc(d),
                                (void 0 != d.closediv || null != d.closediv) && a.closefloatdiv(),
    ...
    qireuser.prototype.urls = new Array(Root + "index.php?s=User-Center-flushinfo", Root + "index.php?s=User-Center-getremindnew"),
    qireuser.prototype.gu = function() {
        $.get(Root + "index.php?s=User-Center-flushinfo", "",
            function(a) {
                return - 7 == parseInt(a.rcode) ? ($.showfloatdiv({
                    ...
                    rcode: -1,
                    msg: a.msg
                }), !1) : (a.uid > 0 && (qruser = a, parseInt(a.history) > 5 ? ($("#morelog").html('<a target="_blank" href="index.php?m=user-index.html">进入我的主页查看完整播放记录&gt;&gt;</a>'), $("#morelog").show()) : ($("#morelog").html(""), $("#morelog").hide()), loginhtml = $("#loginbarx").html(), $("#loginbarx").html(a.html), $("#loginbar").hide(), $(".logoutbt").unbind(), $(".logoutbt").click(function() {
                    return $.showfloatdiv({
                        txt: "正在退出...",
                        cssname: "loading",
                        isajax: 1,
                        succdo: function(a) {
                            ...
                            a.wantredir = null,
                                ...
                                $("#loginform_web #btnLogin").click(function() {
                                    try {
                                        userlogin()
                                    } catch(a) {}
                                }),
    ...
    qireuser.prototype.gr = function() {
        $.get(this.urls[1] + "-" + this.parms[1], "",
            function(a) {
                this.r = a,
                parseInt(a[0]) && $("#" + e.rbox).html("订阅更新<strong>(" + a[0] + ")</strong>")
            },
            "jsonp")
    },
...
checkcookie() && qr.gu({
    ...
    function(a, b, c) {
        ...
        function h() {
            ...
            U.rel = U.rel || Z.rel || "nofollow",
                U.href = U.href || a(Z).attr("href"),
                U.title = U.title || Z.title,
        ...
        function j() {
            ...
            U.slideshow && I[1] ? (d = function() {
                P.text(U.slideshowStop).unbind(c).bind(t,
                    function() { (U.loop || I[$ + 1]) && (a = setTimeout(eb.next, U.slideshowSpeed))
                    }).bind(s,
                    function() {
                        clearTimeout(a)
                    }).one(c + " " + u, e),
                    B.removeClass(b + "off").addClass(b + "on"),
                    a = setTimeout(eb.next, U.slideshowSpeed)
            },
                e = function() {
                    clearTimeout(a),
                        P.text(U.slideshowStart).unbind([t, s, u, c].join(" ")).one(c,
                            function() {
                                eb.next(),
                                    d()
                            }),
        ...
        function k(b) {
            cb || (Z = b, h(), I = a(Z), $ = 0, "nofollow" !== U.rel && (I = a("." + q).filter(function() {
                ...
                return b === U.rel
            }), $ = I.index(Z), -1 === $ && (I = I.add(Z), $ = I.length - 1)), ab || (ab = bb = !0, B.show(), U.returnFocus && a(Z).blur().one(v,
                function() {
                    a(this).focus()
                }), A.css({
                opacity: +U.opacity,
                cursor: U.overlayClose ? "pointer": "auto"
            }).show(), U.w = f(U.initialWidth, "x"), U.h = f(U.initialHeight, "y"), eb.position(), y && J.bind("resize." + z + " scroll." + z,
                function() {
                    A.css({
                        width: J.width(),
                        height: J.height(),
        ...
        function l() { ! B && b.body && (gb = !1, J = a(c), B = d(fb).attr({
            id: o,
            "class": x ? p + (y ? "IE6": "IE") : ""
        ...
        function m() {
            return B ? (gb || (gb = !0, V = E.height() + H.height() + D.outerHeight(!0) - D.height(), W = F.width() + G.width() + D.outerWidth(!0) - D.width(), X = K.outerHeight(!0), Y = K.outerWidth(!0), B.css({
                ...
                function(a) {
                    var b = a.keyCode;
                    ab && U.escKey && 27 === b && (a.preventDefault(), eb.close()),
                    ab && U.arrowKey && I[1] && (37 === b ? (a.preventDefault(), R.click()) : 39 === b && (a.preventDefault(), Q.click()))
                }), a("." + q, b).live("click",
                function(a) {
        ...
        a.colorbox || (a(l), eb = a.fn[o] = a[o] = function(b, c) {
            ...
            eb.position = function(a, b) {
                function c(a) {
                    E[0].style.width = H[0].style.width = D[0].style.width = a.style.width,
                        D[0].style.height = F[0].style.height = G[0].style.height = a.style.height
                }
                var d = 0,
                    e = 0,
                    g = B.offset(),
                ...
                J.unbind("resize." + p),
                    ...
                    a = B.width() === U.w + Y && B.height() === U.h + X ? 0 : a || 0,
                    ...
                    B.dequeue().animate({
                        ...
                        },
                        {
                            ...
                            complete: function() {
                                c(this),
                                    bb = !1,
                                    C[0].style.width = U.w + Y + W + "px",
                                    C[0].style.height = U.h + X + V + "px",
            ...
            eb.resize = function(a) {
                ab && (a = a || {},
                a.width && (U.w = f(a.width, "x") - Y - W), a.innerWidth && (U.w = f(a.innerWidth, "x")), K.css({
                    width: U.w
            ...
            eb.prep = function(b) {
                function c() {
                    return U.w = U.w || K.width(),
                        U.w = U.mw && U.mw < U.w ? U.mw: U.w,
                        U.w
                }
                function f() {
                    return U.h = U.h || K.height(),
                        U.h = U.mh && U.mh < U.h ? U.mh: U.h,
                        U.h
                }
                if (ab) {
                    var h, j = "none" === U.transition ? 0 : U.speed;
                    K.remove(),
                        K = d(fb, "LoadedContent").append(b),
                        K.hide().appendTo(L.show()).css({
                            width: c(),
                        ...
                        h = function() {
                            ...
                            if (ab) {
                                if (n = function() {
                                    ...
                                    if ("string" == typeof U.current && O.html(U.current.replace("{current}", $ + 1).replace("{total}", h)).show(), Q[U.loop || h - 1 > $ ? "show": "hide"]().html(U.next), R[U.loop || $ ? "show": "hide"]().html(U.previous), U.slideshow && P.show(), U.preloading) for (c = [e( - 1), e(1)]; f = I[c.pop()];) q = a.data(f, o).href || f.href,
                                    a.isFunction(q) && (q = q.call(f)),
                                    g(q) && (r = new Image, r.src = q)
                                } else T.hide();
                                U.iframe ? (k = d("iframe")[0], l in k && (k[l] = 0), m in k && (k[m] = "true"), k.name = p + +new Date, U.fastIframe ? n() : a(k).one("load", n), k.src = U.href, U.scrolling || (k.scrolling = "no"), a(k).addClass(p + "Iframe").appendTo(K).one(w,
                                    function() {
                                        k.src = "//about:blank"
                                    })) : n(),
                                    "fade" === U.transition ? B.fadeTo(j, 1, b) : b()
                            }
                        },
                        "fade" === U.transition ? B.fadeTo(j, 0,
                            function() {
                                eb.position(0, h)
                            }) : eb.position(j, h)
                }
            ...
            eb.load = function(b) {
                ...
                b || h(),
                    i(w),
                    i(s, U.onLoad),
                    U.h = U.height ? f(U.height, "y") - X - V: U.innerHeight && f(U.innerHeight, "y"),
                    U.w = U.width ? f(U.width, "x") - Y - W: U.innerWidth && f(U.innerWidth, "x"),
                    U.mw = U.w,
                    U.mh = U.h,
                U.maxWidth && (U.mw = f(U.maxWidth, "x") - Y - W, U.mw = U.w && U.w < U.mw ? U.w: U.mw),
                U.maxHeight && (U.mh = f(U.maxHeight, "y") - X - V, U.mh = U.h && U.h < U.mh ? U.h: U.mh),
                    ...
                    db = setTimeout(function() {
                        ...
                        100),
                    U.inline ? (d(fb).hide().insertBefore(a(c)[0]).one(w,
                        function() {
                            a(this).replaceWith(K.children())
                        }), j(a(c))) : U.iframe ? j(" ") : U.html ? j(U.html) : g(c) ? (a(_ = new Image).addClass(p + "Photo").error(function() {
                        U.title = !1,
                            j(d(fb, "Error").text("This image could not be loaded"))
                    }).load(function() {
                        var a;
                        _.onload = null,
                        U.scalePhotos && (e = function() {
                            _.height -= _.height * a,
                                _.width -= _.width * a
                        },
                        U.mw && _.width > U.mw && (a = (_.width - U.mw) / _.width, e()), U.mh && _.height > U.mh && (a = (_.height - U.mh) / _.height, e())),
                        U.h && (_.style.marginTop = Math.max(U.h - _.height, 0) / 2 + "px"),
                        I[1] && (U.loop || I[$ + 1]) && (_.style.cursor = "pointer", _.onclick = function() {
                            eb.next()
                        }),
                        x && (_.style.msInterpolationMode = "bicubic"),
                            setTimeout(function() {
                                    j(_)
                                },
                                1)
            ...
            eb.next = function() { ! bb && I[1] && (U.loop || I[$ + 1]) && ($ = e(1), eb.load())
            },
            eb.prev = function() { ! bb && I[1] && (U.loop || $) && ($ = e( - 1), eb.load())
            },
            eb.close = function() {
                ab && !cb && (cb = !0, ab = !1, i(u, U.onCleanup), J.unbind("." + p + " ." + z), A.fadeTo(200, 0), B.stop().fadeTo(300, 0,
                    function() {
                        B.add(A).css({
                            opacity: 1,
                            cursor: "auto"
            ...
            eb.remove = function() {
                a([]).add(B).add(A).remove(),
                    B = null,
                    a("." + q).removeData(o).removeClass(q).die()
            },
            eb.element = function() {
                return a(Z)
            },
    ...
    $(".logoutbt").click(function() {
        return $.showfloatdiv({
            ...
            isajax: 1,
            succdo: function() {
                setTimeout("$.refresh('index.php?m=user-login.html')", 500)
            }
        }),
            !1
    }),
    $(document).ready(function() {
        $("#cmt-input-tip .ui-input").focus(function() {
            ...
            $(".user-bt").each(function() {
                ...
                a.click(function() {
                    if (!checkcookie()) return login_form(),
                        !1;
                    $.showfloatdiv({
                        txt: "数据提交中...",
                        cssname: "loading"
                    ...
                    $.get(a.attr("data"),
                        function(a) {
                            $.hidediv(a),
                                parseInt(a.rcode) > 0 ? (d.hide(), c.show(), b.show()) : parseInt(a["yjdy"]) > 0 && 1 == parseInt(a["yjdy"]) && (d.hide(a), c.show(), b.show())
                        },
                        "json")
                }),
                    b.click(function() {
                        $.showfloatdiv({
                            ...
                            $.get(b.attr("data"),
                                function(b) {
                                    $.hidediv(b),
                                    parseInt(b.rcode) > 0 && (a.show(), c.hide())
                                },
                                "json")
                    })
            }),
    ...
    $(".focus,.ated").click(function() {
        ...
        $.ajax({
            ...
            success: function(a) {
                $.hidediv(a),
                parseInt(a.rcode) > 0 && (2 == a.docode ? b.removeClass("ated").addClass("focus").html("+关注").attr("data", "/user-userdo-focususer-uid-" + b.attr("val")) : b.removeClass("focus").addClass("ated").html("已关注").attr("data", "/user-userdo-delfocus-uid-" + b.attr("val")), "function" == typeof getfocusuid && getfocusuid())
            },
            dataType: "json"
        })
    }),
