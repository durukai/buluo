function $Showhtml(){
	...
	player +='<param name="movie" value="'+ff_root+'Public/player3.0/flv.swf"><param name="quality" value="high">';
	...
	player +='<embed src="'+ff_root+'Public/player3.0/flv.swf" allowFullScreen="true" FlashVars="vcastr_file='+Player.Url+'&vcastr_title=www.feifeicms.com&IsAutoPlay=1" menu="false" quality="high" width="100%" height="'+Player.Height+'" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></object>';	
	return player;
}
Player.Show();
