...
<tr><td style="background:#FFF; padding:20px 10px; font-size:12px; line-height:25px">
	<font style="color:#FF0000;font-size:14px"><?php echo ($message); ?></font><br />系统将在<span id="countDownSec" style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span>&nbsp;秒后自动跳转，如果不想等待请<a href="<?php echo ($jumpUrl); ?>" style="color:#069;">点击这里</a>
</td></tr>
</table>
