...
<body>
<?php if($_GET[year]) $u_year="-year-".$_GET[year];else $u_year=NULL;if($_GET[area]) $u_area="-area-".$_GET[area];else $u_area=NULL;if($_GET[language]) $u_language="-language-".$_GET[language];else $u_order=NULL;if($_GET[order]) $u_order="-order-".$_GET[order];else $u_order=NULL;
if($_GET[mcid]) $u_mcid="-mcid-".$_GET['mcid'];else $u_mcid=NULL;if($_GET[letter]) $u_letter="-letter-".$_GET[letter];else $u_letter=NULL;if($_GET[lz]) $u_lz="-lz-".$_GET[lz];else $u_lz=NULL;if($_GET[picm]) $u_picm="-picm-".$_GET[picm];else $u_picm=NULL; ?>
</head>
<body>
<!-- header -->
...
<?php if(is_array($array_listid)): $i = 0; $__LIST__ = array_slice($array_listid,0,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ff_listid): ++$i;$mod = ($i % 2 )?><li><a <?php if(($list_id)  ==  $ff_listid): ?>class="current"<?php endif; ?> href="<?php echo getlistname($ff_listid,'list_url');?>" data="id-<?php echo ($ff_listid); ?>"><?php echo getlistname($ff_listid);?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
<?php else: ?>
 ...
 <?php $array_listid = getlistarr($list_pid); ?><?php if(is_array($array_listid)): $i = 0; $__LIST__ = array_slice($array_listid,0,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ff_listid): ++$i;$mod = ($i % 2 )?><li><a <?php if(($list_id)  ==  $ff_listid): ?>class="current"<?php endif; ?> href="<?php echo getlistname($ff_listid,'list_url');?>" data="id-<?php echo ($ff_listid); ?>"><?php echo getlistname($ff_listid);?></a></li><?php endforeach; endif; else: echo "" ;endif; ?><?php endif; ?>
</ul></div><?php endif; ?>
