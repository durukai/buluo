...
class VodAction extends BaseAction{
    ...
    public function add(){
		...
		if($vod_id){
		    ...
		    $array['vod_cid'] = cookie('vod_cid');//默认数字0
		    $array['vod_stars'] = 1;
		    $array['vod_status'] = 1;
			$array['vod_hits'] = 0;
			$array['vod_zhanti'] = 0;
    ...
    public function _before_insert(){
		...
		$_POST['vod_prty'] = empty($_POST['vod_prty']) ? 0 : implode(',', $_POST['vod_prty']);//
