...
public function create(){
		echo'<iframe scrolling="no" src="?s=Admin-Create-specialid-id-'.implode(',',$_POST['ids']).'" frameborder="0" style="display:none"></iframe>';
		$this->assign("jumpUrl",$_SESSION['special_jumpurl']);
