...
class ApiAction extends BaseapiAction{
    ...
    public function add(){
		...
		if($vod_id){
			...
			$array['vod_filmtime'] = $_SESSION['vod_filmtime'];
			$array['vod_continu'] = 0;
    ...
    public function _before_insert(){
		...
		$vod_url=array();
		$vod_play_arr=array("bdhd","qvod","tudou","yuku","qiyi","pvod","baofeng","sinahd","sinaz","sohu","wole","souhu","ku6","qq","web9","gvod","swf","flv","pptv","pplive","letv","cntv","wasu","fengxing","funshion","m1905","ifeng","cool","xunlei","tudou2","xunlei2","media","real","pps","joy","yinyuetai","v163","ifeng","imgo","down1","down2","down3","down4","down5","down6","down7");
