<?php
class Xml91zyAction extends BaseAction
{
    // 资源列表
    ...
    public function xml_feifei($array_url)
    {
        ...
        if ($json) {
            ...
            $array_tpl = array();
            $array_url['p'] = '{!page!}';
            $array_tpl['pageurl'] = U('Admin-Xml91zy/Feifei', $array_url);
    ...
    public function xml_caijia($array_url)
    {
        ...
        if ($xml) {
            ...
            $array_url['p'] = '{!page!}';
            $array_tpl['pageurl'] = U('Admin-Xml91zy/Caijia', $array_url);
