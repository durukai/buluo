<?php
class XmlfeifeizyAction extends BaseAction{
	// 资源列表
    ...
    public function xml_feifei($array_url){
		...
		if ($json) {
			...
			$array_tpl = array();
			$array_url['p'] = '{!page!}';
			$array_tpl['pageurl'] = U('Admin-Xmlfeifeizy/Feifei',$array_url);
    ...
    public function xml_caijia($array_url){
		...
		if ($xml) {
			...
			$array_url['p'] = '{!page!}';
			$array_tpl['pageurl'] = U('Admin-Xmlfeifeizy/Caijia',$array_url);
